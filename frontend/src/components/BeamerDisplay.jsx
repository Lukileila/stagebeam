    ...
    const displayInstruction = ()=>{
        if (!fullscreen) {return(
                            ...
                            <div className='absolute flex flex-col flex-wrap w-full h-full p-2 justify-center justify-items-center items-center content-center'>
                                <p className=' text-yellow-400 text-3xl'>Drag this window onto the beamer screen and make it fullscreen!</p>
                                <p className=' text-yellow-400 text-xl'>Display settings must be:</p><p className=' text-yellow-400 text-xl'>[ Multiple screens: Extend these diesplays. ]</p>
